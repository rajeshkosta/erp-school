...
const checkIfExist = async (academic_year_id, fees_type_id) => {
    try {
        const query = {
            text: QUERY.FEEMASTER.checkIfExist,
            values: [academic_year_id, fees_type_id],
        };
...
const getAllfeesMaster = async (academic_year_id,school_id) => {
    try {

        const query = {
            text: QUERY.FEEMASTER.getAllfeesMaster,
            values: [academic_year_id,school_id],
        };
...
const getFeeMasterDatabyFeeMasterId = async (fees_master_id) => {
  ...
  const checkIfExistbyID = async (feeMasterDetails) => {
    try {
        const query = {
            text: QUERY.FEEMASTER.checkIfExistbyId, 
            values: [ feeMasterDetails.academic_year_id, feeMasterDetails.fees_type_id, feeMasterDetails.fees_master_id], 
        };
