...
router.post("/create", async (req, res) => {
    try {
        ...
        const { fee_master,academic_year_id } = req.body; 
        ...
        for (const fee of fee_master) {
            ...
            const checkFeeMasterTypeExists = await feeMasterService.checkIfExist(fee_obj.academic_year_id, fee_obj.fees_type_id);
...
router.post('/getFeeMasterGridByClassId', async (req, res) => {
    try {
        ...
        const feeMasterDetails = await feeMasterService.getAllfeesMaster(academic_year_id,school_id);
...
router.post('/update', async (req, res) => {
    try {
        ...
        const checkIfExistbyID = await feeMasterService.checkIfExistbyID(feeMasterDetails);
