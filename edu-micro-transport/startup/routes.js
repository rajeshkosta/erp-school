...
module.exports = function (app) {
    ...
    app.use(function (err,req, res, next) {
        ...
        if (err) {
            console.error('Inside Parser Error:', err);
    ...
    app.use("/api/v1/transport", indexRoute);
    app.use("/api/v1/transport/vehicle", vehicleRoute);
    app.use("/api/v1/transport/driver", driverRoute);
    app.use("/api/v1/transport/route",routeRoute)
};
